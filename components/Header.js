...
export default function Header() {
    return (
      <div className='bg-black text-center p-10'>
          ...
          <p className='text-white text-xl'>Bring your backyard to life with our Do-it-yourself Pergola systems. Whether you want to spend time with family enjoying the outdoors, or entertain a company party our pergolas will bring your backyard to the next level.</p>
